...
static const uint8_t ist8310_write_reg_data_error[IST8310_WRITE_REG_NUM][3] =
    {
        {0x0B, 0x08, 0x01},			// data ready register enabled
        {0x41, 0x09, 0x02},			// output è una media tra 2 valori
        {0x42, 0xC0, 0x03},			// 0xC0 = 11000000 normal operation mode
        {0x0A, 0x0B, 0x04}};		// 0x0B = 1011 single measurement mode

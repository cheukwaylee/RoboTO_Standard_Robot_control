...
char motor_speed_print[30]; //check if 30 is too much
...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
    ...
    switch (rx_header.StdId)
    {
        ...
        case CAN_TRIGGER_MOTOR_ID:
        {
          ...
          get_motor_measure(&motor_measures[i], rx_data);
...
/**
  * @brief          send control current of motor (0x205, 0x206, 0x207, 0x208)			ACTUALLY THIS MOTOR IS CONTROLLED THROUGH VOLTAGE AND NOT CURRENT
